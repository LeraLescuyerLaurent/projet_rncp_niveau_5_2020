...
class getPsysh_Command_ShellCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['psysh.command.shell_command'] = $instance = new \Fidry\PsyshBundle\Command\PsyshCommand(($container->services['psysh.shell'] ?? $container->load('getPsysh_ShellService')));
